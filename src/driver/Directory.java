 ...
 * subdirectories and files. It also stores a reference to the parent
 * directory.
 */
public class Directory extends FileTypes {
    ...
    public void add(FileTypes addObject)
        ...
        if (addObject == this)
            throw new InvalidAddition(
                    "Can not add the current directory object as the child of "
    ...
    public class InvalidAddition extends Exception {
        ...
        //Create a InvalidAddition exception
