...
public class Directory extends FileTypes {
   ...
   * @throws InvalidAddition Thrown when user tries to add the current directory
   *         object to the current directory
   */
  public void add(FileTypes addObject)
    ...
    if (addObject == this)
      throw new InvalidAddition(
          "Can not add the current directory object as the child of the "
              + "current directory.");
