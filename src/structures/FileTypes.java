...
public abstract class FileTypes {
	 ...
	 *
	 * @param dir
	 *            The directory to make the parent of this object
	 * @throws InvalidSetParentException
	 *             Thrown when a user tries to set the parent directory of this
	 *             FileType object but the parent directory doesn't already
	...
	public void setParent(Directory dir) throws InvalidSetParentException {
		...
		// as a child. This is a safety measure to ensure the child points to
		// the
	 ...
	 *             Thrown when the new already exists in the parent directory
	 */
	 ...
	 * 
	 * @param src
	 *            The fileType object to add
	 * @param dest
	 *            The fileType object to add to
	...
	public static FileTypes deepCopy(FileTypes ft) {
		if (ft instanceof File)
			...
			// This should always work since the original directory couldn't
			// have
