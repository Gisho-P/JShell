...
/**
 * The InvalidSetParentException is thrown when a user tries to set the parent
 * directory of this FileType object but the parent directory doesn't contain
 * this FileType object
 */
public class InvalidSetParentException extends Exception {
  ...
  public InvalidSetParentException() {
    super(
        "Unable to set the parent directory of this " + "FileType object. The "
