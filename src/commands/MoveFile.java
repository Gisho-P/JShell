...
/**
 * The Class MoveFile replicates the mv command in shell. It allows the moving
...
public class MoveFile implements Command {
  ...
  /**
   * Used to perform the mv command. Moves directories or files from src to the
  ...
  public void exec(List<String> args) {
    ...
    try {
      ...
      if (dest instanceof File) {
        ...
        | MissingNameException | InvalidNameException | NameExistsException e) {
   ...
   * @throws InvalidNameException When Invalid name is entered for the directory
  ...
  private void destIsFile(FileTypes src, FileTypes dest, Directory parent)
      throws MissingNameException, InvalidNameException, NameExistsException,
  ...
  private void moveAndReplace(FileTypes src, Directory dest, String newName,
      Directory parent) throws MissingNameException, InvalidNameException,
