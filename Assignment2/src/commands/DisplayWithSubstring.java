...
public class DisplayWithSubstring implements Command {
  ...
  public void execDir(List<String> args) {
    ...
    try {
      Directory start = ((Directory) FilePathInterpreter
          .interpretPath(s.getCurrentDir(), args.get(3)));
   ...
   * 
   * @param file A file to the substrings of.
   * @param regex The regex to be compared to.
