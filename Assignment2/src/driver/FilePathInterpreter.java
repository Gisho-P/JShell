...
public class FilePathInterpreter {
	 ...
	 *
	 * @param init
	 *            The init dir to move from.
	 * @param path
	 *            The path relative to the init dir.
	 ...
	 *
	 * @param init
	 *            The current dir the path is relative to.
	 * @param currPath
	 *            The current path of the dir/file.
	 ...
	 * 
	 * @param init
	 *            The dir the file is found at.
	 * @param currPath
	 *            The current path of the file.
	 * @param splitPath
	 *            An array split from currPath with the '/' delimiter;
	 ...
	 * 
	 * @param init
	 *            The dir the subdir is found at.
	 * @param currPath
	 *            The current path of the subdir.
	 * @param splitPath
	 *            An array split from currPath with the '/' delimiter;
	 * @return A file with the given path relative to init;
	 * @throws InvalidDirectoryPathException
	...
	/**
	 * Parses the current single dot from currPath and calls interpretPath
	 * again.
	 * 
	 * @param init
	 *            The dir to interpret the path from.
	 * @param currPath
	 *            The current path of the file.
	 * @param splitPath
	 *            An array split from currPath with the '/' delimiter;
	 ...
	 * @throws InvalidDirectoryPathException
	 */
	private static FileTypes interpretSingleDot(Directory init,
			String currPath, String[] splitPath)
			throws InvalidDirectoryPathException {
	 ...
	 * @throws InvalidDirectoryPathException
	 */
	private static FileTypes interpretDoubleDots(Directory init,
			String currPath, String[] splitPath)
			throws InvalidDirectoryPathException {
